...
def play_game():
    ...
    while tic_tac_toe_plays < 10:
        print("")
        print("{}|{}|{}".format(numbers_list[0], numbers_list[1], numbers_list[2]))
        print("-+-+-")
        print("{}|{}|{}".format(numbers_list[3], numbers_list[4], numbers_list[5]))
        print("-+-+-")
        print("{}|{}|{}".format(numbers_list[6], numbers_list[7], numbers_list[8]))
        print("")
